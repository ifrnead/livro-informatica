...
% ---
\titulo{Livro de informática Básica}
\autor{Grupo de Computação EaD}
\data{2016, v-0.1}
\preambulo{Breve contextualização do livro}
\local{Natal, IFRN-EaD}
\instituicao{IFRN-EaD \\ v-0.1}
...
\huge 
{\raggedleft
\includegraphics[scale=0.2]{./imagens/IfrnEad.pdf}\\[1cm]
...
% ------------------------------------------------------------
%\chapter*[Introdução]{Introdução2}
%\addcontentsline{toc}{chapter}{Introdução3}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\bibliography{referencias} % insere o arquivo de bibliografia
% ------------------------------------------------------------
